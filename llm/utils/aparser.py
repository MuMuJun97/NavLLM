...
def load_parser():
    ...
    ############# Model ###############
    parser.add_argument('--Net', type=str, default='google/flan-t5-small')
    ...
    parser.add_argument(
        "--model_config", type=str, default=None, help="path to model structure config json"
    )
    parser.add_argument(
        "--checkpoint", default=None, type=str, help="path to model checkpoint (*.pt)"
    )
    # can use config files
    parser.add_argument("--config", type=str, default="cfg/soon_obj_pretrain_qa.json", help="JSON config files")
    parser.add_argument(
        "--output_dir",
        default=None,
        type=str,
